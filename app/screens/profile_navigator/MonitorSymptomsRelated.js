...
export default class MonitorSymptomsRelated extends Component {
    constructor(props) {
        super(props);
        this.state = {
            fever_check: 0,
                ...
                <View style = {stylesGlobal.main_view}>
                    ...
                    <View style = {{flex: 1, width: '100%'}}>
                        <ScrollView style = {{width: '100%', marginTop: 40}}>
                            <Text style = {[stylesGlobal.query_text, {fontFamily: 'Montserrat-Bold'}]}>Do you have any of the following symptoms that you think are related to COVID-19 right now:</Text>
                            ...
                            <View style = {{flex: 1, width: '100%', }}>
                                ...
                                <View style = {[styles.component_view, {borderColor: this.state.other_check == 0 ? '#c0c0c0' : this.state.other_check == 1 ? '#0093B8' : '#808080'}]}>
                                    <Text style = {[stylesGlobal.landing_screen_text, {flex: 1,}]}>{this.state.other_check == 0 ? 'Other' : this.state.other_check == 1 ? 'Reduces smell and/or taste' : 'Please specify'}</Text>
                                    <TouchableOpacity style = {styles.check_button_view} 
                                        onPress = {() => {
                                ...
                                <TouchableOpacity style = {[stylesGlobal.submit_button, {marginTop: 40}]} 
                                    onPress = {() => {
                                        this.props.navigation.navigate("MonitorSymptomsExpose");
                                    }}
                                >
